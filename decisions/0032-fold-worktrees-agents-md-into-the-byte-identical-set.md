...
[0037](0037-replace-task-index-with-frontmatter.md) removes the index contrast and template
claims; [0041](0041-define-governed-agent-sublayers.md) classifies the worktrees contract as a
recognized sublayer contract without changing its byte-identical managed-rule set.
