...
| [2026-08-13-record-index-order](archive/2026-08-13-record-index-order/task.md) | completed | Record that the task index is ordered newest first, and state the rule in the portable tasks instructions |
